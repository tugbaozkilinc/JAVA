...
public class LinkedHashSet01 {
    ...
    /*
      LinkedHashSet ler elemanlari ekleme sirasina(insertion order) gore yerlestirir. LinkedHashSet elemanlari siralamada zaman harcadigi icin
      HashSet lere gore yavas calisir.
    */
