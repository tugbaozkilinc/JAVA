...
public class HashMap02 {
    ...
    /*
      1. Siz "HashMap<String, Double> salaries = new HashMap<>();" kodunu yazdığınızda Java memory'de 16 kutu(bucket) içeren bir yapı oluşturur ve
         bu yapıdaki her bir kutuya index verir. Index'ler 0'dan 15'e kadardır.
      2. Siz "salaries.put("QA", 110000.00);" kodunu yazdığınızda Java key için bir HashCode oluşturur, bu HashCode'u 16'a böler ve kalanı index olarak kullanır.
      ...
      3. Yerleştirirken 4'lü bir yapı oluşturur, bu yapının ilk bölümüne "HashCode"u, ikinci bölümüne "Key"i, üçüncü bölümüne "Value" u ve dördüncü bölümüne
         "pointer"ı koyar. Bu çok bölümlü yapı LinkedList'lerdeki "Node" dur. Yani HashMap, bucket'lara koyduğu data'yı LinkedList olarak depolar. Her bir
         bucket da LinkedList vardir.
         Note: Java dan bu depoladigimiz entry leri istedigimizde java hem hashcode u hem key i hem de value yu kontrol ettikten sonra o data yi bize dondurur.
